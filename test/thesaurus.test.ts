...
const frequentDailyBatch300 = ["หน้าผาก","คิ้ว","หู","จมูก","ลิ้น","คาง","คอ","ไหล่","แขน","ศอก","ข้อมือ","นิ้ว","เล็บ","อก","เอว","สะโพก","ขา","เข่า","ข้อเท้า","ส้นเท้า","ผิว","กระดูก","กล้ามเนื้อ","สมอง","อวัยวะ","น้ำมูก","เวียนหัว","ท้องเสีย","อักเสบ","ติดเชื้อ","วิตามิน","ออกกำลังกาย","หายใจ","หลังคา","ระเบียง","รั้ว","สนาม","โรงรถ","ชั้น","ทางเดิน","ลิฟต์","พัดลม","เครื่องปรับอากาศ","หลอดไฟ","เตา","ตู้เย็น","ไมโครเวฟ","หม้อ","กระทะ","จาน","ชาม","ถ้วย","แก้ว","ช้อน","ส้อม","เขียง","กาต้มน้ำ","เครื่องซักผ้า","ตู้เสื้อผ้า","ชั้นวางของ","ลิ้นชัก","ถังขยะ","ไม้กวาด","ผ้าเช็ดตัว","สบู่","ยาสีฟัน","แปรงสีฟัน","แชมพู","กระจก","นาฬิกา","โทรทัศน์","วิทยุ","สายชาร์จ","ปลั๊ก","สวิตช์","รีโมต","ของใช้","เฟอร์นิเจอร์","เครื่องใช้ไฟฟ้า","ไข่","กล้วย","ส้ม","แอปเปิล","แตงโม","ขนมปัง","ก๋วยเตี๋ยว","ซุป","แกง","น้ำปลา","น้ำตาล","เกลือ","พริก","กระเทียม","น้ำมัน","ซอส","น้ำแข็ง","น้ำอัดลม","เบียร์","ไวน์","มื้อกลางวัน","จานหลัก","วัตถุดิบ","เมนู","สูตรอาหาร","แช่","สุก","ดิบ","สด","เน่า","มัน","กรอบ","เหนียว","ทางแยก","สะพาน","อุโมงค์","ป้าย","สัญญาณ","ไฟจราจร","ป้ายรถเมล์","สนามบิน","ท่าเรือ","ปั๊มน้ำมัน","ลานจอดรถ","รถจักรยานยนต์","จักรยาน","รถเมล์","รถไฟ","แท็กซี่","คนขับ","ผู้โดยสาร","ตั๋ว","ค่าโดยสาร","แผนที่","การจราจร","รถติด","อุบัติเหตุ","ความเร็ว","ปลายทาง","จุดเริ่มต้น","ทางเข้า","ทางออก","ทางตรง","ทางโค้ง","ทางลัด","พักแรม","กระเป๋าเดินทาง","หนังสือเดินทาง","จังหวัด","อำเภอ","ตำบล","ประเทศ","การบ้าน","แบบฝึกหัด","ข้อสอบ","เกรด","นักศึกษา","ห้องเรียน","ห้องสมุด","โครงการ","เป้าหมาย","พนักงาน","บริษัท","องค์กร","แผนก","เอกสาร","แบบฟอร์ม","ลายเซ็น","ตาราง","กำหนดการ","รายงาน","ผลงาน","ประสบการณ์","ความสามารถ","ความคิด","ไอเดีย","การตัดสินใจ","ข้อตกลง","เงื่อนไข","นโยบาย","ขั้นตอน","ผลลัพธ์","ความสำเร็จ","ความล้มเหลว","โอกาส","ความเสี่ยง","งบประมาณ","รายได้","ค่าใช้จ่าย","กำไร","ขาดทุน","ธนาคาร","บัตรเครดิต","เงินสด","ใบเสร็จ","ใบแจ้งหนี้","ภาษี","อีเมล","กล่องข้อความ","การแจ้งเตือน","การตั้งค่า","โปรไฟล์","ผู้ใช้","ผู้ดูแล","เครือข่าย","การเชื่อมต่อ","ข้อมูลส่วนตัว","ความปลอดภัย","อัปเดต","ติดตั้ง","ถอนการติดตั้ง","สำรองข้อมูล","กู้คืน","ลบ","คัดลอก","แชร์","เข้าสู่ระบบ","ออกจากระบบ","ยืนยันตัวตน","อนุมัติ","ข้อผิดพลาด","ปัญหาทางเทคนิค","เวอร์ชัน","ภาษา","แถบเครื่องมือ","ลิงก์","ที่อยู่เว็บ","ฐานข้อมูล","เซิร์ฟเวอร์","ลาก่อน","ชื่นชม","ตำหนิ","ปลอบ","เสนอ","ต่อรอง","ย้าย","หมุน","ดำเนินต่อ","เสร็จสิ้น","เกิดขึ้น","พัฒนา","ปรับปรุง","เหตุการณ์","สถานการณ์","สภาพแวดล้อม","พฤติกรรม","นิสัย","ความสัมพันธ์","ความคิดเห็น","ความต้องการ","ความรู้สึก","ความสุข","ความเศร้า","ความกลัว","ความโกรธ","ความรัก","ความหวัง","ความกังวล","ความเครียด","ความมั่นใจ","ความตื่นเต้น","ความประหลาดใจ","ความพอใจ","ความเบื่อ","ความเหนื่อย","ความหิว","ความกระหาย","ความเจ็บปวด","ความสะดวก","ความสบาย","ความจำ","ความจริง","ความลับ","ความฝัน","ชีวิต","ความตาย","ธรรมชาติ","อากาศ","แดด","ฤดู","อุณหภูมิ","เป็ด","แมลง","ยุง","มด","แมงมุม","เกาะ","พระจันทร์","พระอาทิตย์","สีแดง","สีฟ้า","สีดำ","สีขาว","สีชมพู","วงกลม","สี่เหลี่ยม","สามเหลี่ยม","เส้น","ขอบ","ฟุตบอล","ภาพยนตร์"];

test("second daily frequency batch adds exactly 300 unique headwords", () => {
  assert.equal(frequentDailyBatch300.length, 300);
  assert.equal(new Set(frequentDailyBatch300).size, 300);
});

test("second daily frequency batch provides curated alternatives and parts of speech", () => {
  for (const word of frequentDailyBatch300) {
    const suggestions = thesaurus.suggest(word);
    assert.ok(suggestions.length >= 3, word);
    assert.ok(suggestions.every(({ pos }) => pos.length > 0), word);
  }
});

test("second daily frequency batch rises from lower to higher register", () => {
  for (const word of frequentDailyBatch300) {
    const ranks = thesaurus.suggest(word).map(({ registerRank }) => registerRank);
    assert.deepEqual(ranks, [...ranks].sort((a, b) => a - b), word);
  }
...
test("second daily frequency batch covers representative daily categories", () => {
  for (const word of ["หน้าผาก", "ตู้เย็น", "มื้อกลางวัน", "สนามบิน", "การบ้าน", "ธนาคาร", "เข้าสู่ระบบ", "ความรู้สึก", "พระจันทร์", "ภาพยนตร์"]) {
    assert.ok(frequentDailyBatch300.includes(word), word);
    assert.ok(thesaurus.suggest(word).length >= 3, word);
  }
});

const frequentDailyBatch300Part2 = ["กระโปรง","ชุดเดรส","เสื้อยืด","เสื้อเชิ้ต","เสื้อกันหนาว","สูท","เนกไท","ถุงเท้า","รองเท้าแตะ","รองเท้าผ้าใบ","รองเท้าบูต","แว่นตา","แว่นกันแดด","เข็มขัด","ผ้าพันคอ","ถุงมือ","ร่ม","กระดุม","ซิป","แขนเสื้อ","คอเสื้อ","ขากางเกง","ฝ้าย","ไหม","ขนสัตว์","สร้อยข้อมือ","กระเป๋าสตางค์","กระเป๋าสะพาย","กระเป๋าเป้","เครื่องสำอาง","ลิปสติก","น้ำหอม","หวี","กิ๊บ","ยางรัดผม","วิศวกร","โปรแกรมเมอร์","นักออกแบบ","นักข่าว","ช่างภาพ","นักบัญชี","ทนายความ","ตำรวจ","นักดับเพลิง","เกษตรกร","พ่อค้า","แม่ค้า","พ่อครัว","แม่ครัว","บริกร","แคชเชียร์","ผู้จัดการ","เลขานุการ","เจ้าหน้าที่","นักวิจัย","นักวิทยาศาสตร์","นักดนตรี","ผู้กำกับ","โค้ช","ช่างไฟ","ช่างไม้","ช่างยนต์","ช่างตัดผม","ช่างเสริมสวย","บุรุษไปรษณีย์","คนส่งของ","ยาม","รปภ","นายหน้า","ที่ปรึกษา","อาสาสมัคร","เจ้าของ","ลูกค้า","ผู้ซื้อ","ผู้ขาย","นักท่องเที่ยว","ร้านอาหาร","ร้านกาแฟ","ห้างสรรพสินค้า","ซูเปอร์มาร์เก็ต","ร้านสะดวกซื้อ","ร้านขายยา","ไปรษณีย์","รีสอร์ต","โรงภาพยนตร์","โรงละคร","พิพิธภัณฑ์","โบสถ์","มัสยิด","สวนสาธารณะ","สระว่ายน้ำ","โรงยิม","ตลาดสด","โรงงาน","คลังสินค้า","ศูนย์การค้า","ศูนย์บริการ","สถานีตำรวจ","สถานีดับเพลิง","ศาล","สถานทูต","ชายแดน","ด่านตรวจ","วิทยาลัย","โรงเรียนอนุบาล","โรงเรียนประถม","โรงเรียนมัธยม","คลินิก","ห้องฉุกเฉิน","ห้องผ่าตัด","ห้องตรวจ","ห้องประชุม","ห้องรับแขก","ห้องอาหาร","ห้องน้ำสาธารณะ","หนู","กระรอก","แพะ","ห่าน","กุ้ง","ปู","หอย","เต่า","กบ","จระเข้","ลิง","หมี","โลมา","วาฬ","ฉลาม","ผีเสื้อ","ผึ้ง","แมลงวัน","แมลงสาบ","จิ้งจก","ตุ๊กแก","ไส้เดือน","ลำต้น","หน่อ","ทุ่งนา","สวนผลไม้","สมุนไพร","เห็ด","มอส","สาหร่าย","บาสเกตบอล","วอลเลย์บอล","เทนนิส","แบดมินตัน","กอล์ฟ","ว่ายน้ำ","วิ่งแข่ง","ปั่นจักรยาน","โยคะ","เล่นดนตรี","วาดรูป","ระบายสี","เขียนหนังสือ","ปลูกต้นไม้","ตกปลา","ตั้งแคมป์","เดินป่า","ปีนเขา","ช้อปปิ้ง","สะสม","เล่นเกม","ฟังเพลง","การฝึกซ้อม","ทีมกีฬา","สนามแข่งขัน","กรรมการ","กองเชียร์","เหรียญ","สถิติ","รอบชิงชนะเลิศ","รอบคัดเลือก","แชมป์","คะแนนเสมอ","กติกา","ค้อน","ตะปู","ไขควง","คีม","เลื่อย","สว่าน","เชือก","เทป","กาว","กรรไกร","ไม้บรรทัด","ดินสอ","ยางลบ","สมุด","ซองจดหมาย","แฟ้ม","คลิปหนีบกระดาษ","เครื่องพิมพ์","เครื่องสแกน","เครื่องคิดเลข","เครื่องมือช่าง","อุปกรณ์","วัสดุ","เหล็ก","อะลูมิเนียม","ทองแดง","พลาสติก","ยาง","กระเบื้อง","ปูนซีเมนต์","อิฐ","กระดาษแข็ง","ผ้าใบ","ฟองน้ำ","น้ำยา","สีทาบ้าน","แปรง","ลูกกลิ้ง","ถัง","ท่อ","วาล์ว","น็อต","สกรู","ลวด","โซ่","แบตเตอรี่","มอเตอร์","เครื่องยนต์","ล้อ","ยางรถยนต์","เบรก","พวงมาลัย","อดทน","ใจร้อน","ใจกว้าง","ใจแคบ","เป็นมิตร","เชื่อฟัง","วุ่นวาย","ยุ่งเหยิง","มีชื่อเสียง","นิรนาม","เป็นไปไม่ได้","เหมาะสม","ไม่เหมาะสม","มีประโยชน์","ไร้ประโยชน์","ไม่จำเป็น","สมบูรณ์","บกพร่อง","ถูกกฎหมาย","ผิดกฎหมาย","ยุติธรรม","ไม่ยุติธรรม","ลึกลับ","คลุมเครือ","ไม่แน่นอน","ถาวร","ทันสมัย","ล้าสมัย","สาธารณะ","ส่วนตัว","ท้องถิ่น","ต่างชาติ","ดิจิทัล","อัตโนมัติ","ด้วยมือ","ออนไลน์","ออฟไลน์","วันเกิด","วันหยุด","วันทำงาน","วันธรรมดา","วันสุดสัปดาห์","การเดินทาง","การท่องเที่ยว","การซื้อขาย","การชำระเงิน","การสมัครสมาชิก","การยกเลิก","การคืนเงิน","ส่วนลด","โปรโมชั่น","การ์ด","เค้ก","ลูกโป่ง","ดอกไม้ไฟ","การเฉลิมฉลอง","ประเพณี","วัฒนธรรม","สังคม","รัฐมนตรี","นายกรัฐมนตรี","คดี","หลักฐาน","พยาน","ผู้ต้องหา","จำเลย","โจทก์","บทลงโทษ","ค่าปรับ"];

test("third daily frequency batch adds exactly 300 unique headwords", () => {
  assert.equal(frequentDailyBatch300Part2.length, 300);
  assert.equal(new Set(frequentDailyBatch300Part2).size, 300);
});

test("third daily frequency batch provides curated alternatives and parts of speech", () => {
  for (const word of frequentDailyBatch300Part2) {
    const suggestions = thesaurus.suggest(word);
    assert.ok(suggestions.length >= 3, word);
    assert.ok(suggestions.every(({ pos }) => pos.length > 0), word);
  }
...
test("third daily frequency batch rises from lower to higher register", () => {
  for (const word of frequentDailyBatch300Part2) {
    const ranks = thesaurus.suggest(word).map(({ registerRank }) => registerRank);
    assert.deepEqual(ranks, [...ranks].sort((a, b) => a - b), word);
  }
...
test("third daily frequency batch covers representative daily categories", () => {
  for (const word of ["กระโปรง", "โปรแกรมเมอร์", "ร้านอาหาร", "โลมา", "แบดมินตัน", "ไขควง", "ออนไลน์", "วันเกิด", "หลักฐาน", "ค่าปรับ"]) {
    assert.ok(frequentDailyBatch300Part2.includes(word), word);
    assert.ok(thesaurus.suggest(word).length >= 3, word);
  }
});

const frequentDailyBatch300Part3 = ["อ่าว","คลอง","บึง","เนิน","ที่ราบ","ที่ราบสูง","ธารน้ำแข็ง","ภูเขาไฟ","แผ่นดินไหว","ไฟป่า","ดินถล่ม","คลื่น","สึนามิ","น้ำขึ้น","น้ำลง","ฝั่ง","ตลิ่ง","ริมน้ำ","แหลม","คาบสมุทร","ทวีป","โลก","จักรวาล","อวกาศ","ดาวเคราะห์","ดาวหาง","อุกกาบาต","กาแล็กซี","หิมะ","ลูกเห็บ","ลมหนาว","ความชื้น","ความกดอากาศ","คณิตศาสตร์","วิทยาศาสตร์","ฟิสิกส์","เคมี","ชีววิทยา","ดาราศาสตร์","ภูมิศาสตร์","ประวัติศาสตร์","เศรษฐศาสตร์","การเมือง","จิตวิทยา","ปรัชญา","วรรณกรรม","เทคโนโลยี","วิศวกรรม","แพทยศาสตร์","บัญชี","การตลาด","การจัดการ","สถาปัตยกรรม","พลังงาน","มวล","น้ำหนัก","ปริมาตร","ความยาว","พื้นที่","ระยะทาง","ความถี่","คลื่นเสียง","อะตอม","โมเลกุล","ธาตุ","สารประกอบ","ปฏิกิริยา","การทดลอง","สมมติฐาน","ทฤษฎี","สูตร","การคำนวณ","การวัด","หน่วย","มาตรฐาน","แล็ปท็อป","แท็บเล็ต","คีย์บอร์ด","เมาส์","ลำโพง","ไมโครโฟน","หูฟัง","กล้องเว็บแคม","ฮาร์ดดิสก์","หน่วยความจำ","ซีพียู","การ์ดจอ","เมนบอร์ด","ระบบปฏิบัติการ","ซอฟต์แวร์","ฮาร์ดแวร์","แอปพลิเคชัน","เบราว์เซอร์","เว็บเพจ","โดเมน","โฮสติ้ง","คลาวด์","โฟลเดอร์","เอกสารดิจิทัล","ชื่อผู้ใช้","บัญชีผู้ใช้","สิทธิ์การเข้าถึง","การเข้ารหัส","ไฟร์วอลล์","ไวรัส","มัลแวร์","สแปม","คุกกี้","แคช","ประวัติการใช้งาน","สตรีมมิง","การประชุมออนไลน์","โซเชียลมีเดีย","ราชการ","รัฐสภา","วุฒิสภา","สภาผู้แทนราษฎร","กระทรวง","กรม","กอง","สำนัก","เทศบาล","องค์การบริหารส่วนจังหวัด","องค์การบริหารส่วนตำบล","ผู้ว่าราชการ","นายอำเภอ","กำนัน","ผู้ใหญ่บ้าน","การเลือกตั้ง","พรรคการเมือง","ผู้สมัคร","บัตรเลือกตั้ง","คะแนนเสียง","ประชาธิปไตย","รัฐธรรมนูญ","พระราชบัญญัติ","พระราชกำหนด","กฎกระทรวง","คำสั่ง","สิทธิ","เสรีภาพ","ความรับผิดชอบ","ความเสมอภาค","สวัสดิการ","การศึกษา","การสาธารณสุข","เศรษฐกิจ","การคลัง","การป้องกันประเทศ","พ่อแม่","ปู่","ย่า","ยาย","ลุง","ป้า","น้า","อา","หลาน","ลูกพี่ลูกน้อง","เจ้าบ่าว","เจ้าสาว","ญาติ","เพื่อนบ้าน","เพื่อนร่วมงาน","เพื่อนร่วมชั้น","คู่ค้า","หุ้นส่วน","คู่แข่ง","คนรู้จัก","คนแปลกหน้า","กลุ่ม","ชมรม","สมาคม","มูลนิธิ","สหกรณ์","สหภาพ","เครือญาติ","การแต่งงาน","การหย่าร้าง","การหมั้น","การคบหา","การนัดพบ","มิตรภาพ","ความเคารพ","ความเข้าใจ","ความขัดแย้ง","การทะเลาะ","การปรองดอง","การให้อภัย","เดินเข้า","เดินออก","เดินผ่าน","เดินนำ","เดินกลับ","วิ่งหนี","วิ่งตาม","จ้องมอง","เหลือบมอง","เกา","บีบ","หนีบ","คีบ","เสียบ","ห่อ","ร้อย","กาง","ขุด","ฝัง","ให้อาหาร","เลี้ยง","เฝ้า","ตรวจวัด","วิเคราะห์","คำนวณ","ออกแบบ","ขนส่ง","จัดเก็บ","บริการ","ไม่เห็นด้วย","บังคับ","ขออนุญาต","สรุป","โฆษณา","ประชาสัมพันธ์","โน้มน้าว","ชักชวน","เชิญชวน","มอบหมาย","รับผิดชอบ","รับประกัน","กู้ภัย","บริจาค","ร่วมแบ่งปัน","เร็วขึ้น","ช้าลง","มากขึ้น","น้อยลง","ดีขึ้น","แย่ลง","ใกล้ขึ้น","ไกลออกไป","ขึ้นไป","ออกมา","ข้างๆ","รอบๆ","ระหว่าง","ท่ามกลาง","เมื่อก่อน","เมื่อกี้","ครั้งแรก","ครั้งสุดท้าย","บ่อยครั้ง","นานๆที","ประจำ","โดยทั่วไป","โดยเฉพาะ","อย่างน้อย","อย่างมาก","ส่วนใหญ่","เกือบทั้งหมด","โดยตรง","ทางอ้อม","ตามลำดับ","ชั่วขณะ","สายเกินไป","ทำเล็บ","ย้อมผม","เก็บห้อง","จัดบ้าน","หุงข้าว","ซื้ออาหาร","สั่งอาหาร","ส่งอาหาร","รับอาหาร","เปิดร้าน","ปิดร้าน","ทำบัญชี","กู้เงิน","ลงทุน","ออมเงิน","ทำสัญญา","เซ็นสัญญา","ยื่นเอกสาร","รับรองเอกสาร","ส่งคำขอ","รับคำขอ","ติดต่อลูกค้า","นัดลูกค้า","นัดหมอ","พบแพทย์","ตรวจร่างกาย","วัดความดัน","ฉีดยา","ทำแผล","ผ่าตัด","เลิกงาน","ดาวน์โหลดไฟล์","อัปโหลดไฟล์","แชร์หน้าจอ","บันทึกหน้าจอ"];

test("fourth daily frequency batch adds exactly 300 unique headwords", () => {
  assert.equal(frequentDailyBatch300Part3.length, 300);
  assert.equal(new Set(frequentDailyBatch300Part3).size, 300);
});

test("fourth daily frequency batch provides curated alternatives and parts of speech", () => {
  for (const word of frequentDailyBatch300Part3) {
    const suggestions = thesaurus.suggest(word);
    assert.ok(suggestions.length >= 3, word);
    assert.ok(suggestions.every(({ pos }) => pos.length > 0), word);
  }
...
test("fourth daily frequency batch rises from lower to higher register", () => {
  for (const word of frequentDailyBatch300Part3) {
    const ranks = thesaurus.suggest(word).map(({ registerRank }) => registerRank);
    assert.deepEqual(ranks, [...ranks].sort((a, b) => a - b), word);
  }
...
test("fourth daily frequency batch covers representative daily categories", () => {
  for (const word of ["อ่าว", "ฟิสิกส์", "แล็ปท็อป", "รัฐสภา", "พ่อแม่", "เดินเข้า", "วิเคราะห์", "โดยเฉพาะ", "นัดหมอ", "แชร์หน้าจอ"]) {
    assert.ok(frequentDailyBatch300Part3.includes(word), word);
    assert.ok(thesaurus.suggest(word).length >= 3, word);
  }
});

const frequentDailyBatch600 = ["เปิดโทรทัศน์","เปิดวิทยุ","เปิดคอมพิวเตอร์","เปิดโทรศัพท์","เปิดแอป","เปิดเว็บไซต์","เปิดก๊อกน้ำ","ปิดโทรทัศน์","ปิดวิทยุ","ปิดคอมพิวเตอร์","ปิดโทรศัพท์","ปิดแอป","ปิดเว็บไซต์","ปิดก๊อกน้ำ","ตรวจอีเมล","ตรวจข้อความ","ตรวจข้อมูล","ตรวจราคา","ตรวจสภาพอากาศ","ตรวจเส้นทาง","ตรวจเวลา","ตรวจวันที่","ตรวจผลสอบ","ตรวจสถานะ","ตรวจรายการ","ตรวจรายละเอียด","จัดโต๊ะ","จัดห้องครัว","จัดห้องน้ำ","จัดเสื้อผ้า","จัดหนังสือ","จัดเอกสาร","จัดไฟล์","จัดตารางงาน","จัดนัดหมาย","จัดรายการ","จัดข้อมูล","จัดลำดับ","ทำความสะอาดบ้าน","ทำความสะอาดห้องครัว","ทำความสะอาดห้องน้ำ","ทำความสะอาดพื้น","ทำความสะอาดหน้าต่าง","ทำความสะอาดรถ","ทำความสะอาดรองเท้า","ทำความสะอาดเสื้อผ้า","ทำความสะอาดอุปกรณ์","ทำความสะอาดคอมพิวเตอร์","ทำความสะอาดหน้าจอ","ทำความสะอาดแป้นพิมพ์","ล้างช้อน","ล้างผลไม้","ล้างรถ","ล้างพื้น","ล้างห้องน้ำ","ล้างคราบ","ล้างขวด","ล้างถัง","ล้างอุปกรณ์","เตรียมอาหาร","เตรียมอาหารเช้า","เตรียมอาหารกลางวัน","เตรียมอาหารเย็น","เตรียมเสื้อผ้า","เตรียมกระเป๋า","เตรียมเอกสาร","เตรียมข้อมูล","เตรียมอุปกรณ์","เตรียมห้องประชุม","เตรียมสถานที่","เตรียมรถ","เตรียมเงิน","เตรียมคำถาม","เตรียมคำตอบ","ซื้อเครื่องดื่ม","ซื้อยา","ซื้อเสื้อผ้า","ซื้อรองเท้า","ซื้อหนังสือ","ซื้อตั๋ว","ซื้อของขวัญ","ซื้ออุปกรณ์","ซื้อเฟอร์นิเจอร์","ซื้อประกัน","ซื้อแพ็กเกจ","ซื้อสินค้าออนไลน์","ซื้อของใช้","ขายของ","ขายอาหาร","ขายเครื่องดื่ม","ขายเสื้อผ้า","ขายหนังสือ","ขายตั๋ว","ขายรถ","ขายบ้าน","ขายที่ดิน","ขายสินค้าออนไลน์","ขายของมือสอง","ขายบริการ","ขายแพ็กเกจ","ขายหุ้น","ขายทรัพย์สิน","จ่ายค่าอาหาร","จ่ายค่าเดินทาง","จ่ายค่าไฟ","จ่ายค่าน้ำ","จ่ายค่าโทรศัพท์","จ่ายค่าอินเทอร์เน็ต","จ่ายค่าบริการ","จ่ายค่ารักษา","จ่ายค่าปรับ","จ่ายภาษี","จ่ายหนี้","จ่ายบิล","จ่ายค่าเรียน","รับพัสดุ","รับจดหมาย","รับอีเมล","รับข้อความ","รับโทรศัพท์","รับข่าว","รับข้อมูล","รับเอกสาร","รับคำแนะนำ","รับคำเชิญ","รับบริการ","ส่งเงิน","ส่งของ","ส่งพัสดุ","ส่งจดหมาย","ส่งอีเมล","ส่งข้อมูล","ส่งใบสมัคร","ส่งรายงาน","ส่งข่าว","ส่งสัญญาณ","โทรหาเพื่อน","โทรหาครอบครัว","โทรหาลูกค้า","โทรหาหมอ","โทรหาตำรวจ","โทรหาบริษัท","โทรกลับบ้าน","โทรสอบถาม","โทรแจ้งข่าว","โทรนัดหมาย","โทรสั่งอาหาร","โทรจองโต๊ะ","โทรยืนยัน","โทรยกเลิก","โทรขอความช่วยเหลือ","เขียนข้อความ","เขียนอีเมล","เขียนจดหมาย","เขียนบทความ","เขียนรายการ","เขียนคำตอบ","เขียนคำถาม","เขียนความคิดเห็น","เขียนรีวิว","เขียนใบสมัคร","เขียนชื่อ","เขียนที่อยู่","เขียนลายเซ็น","อ่านข่าว","อ่านอีเมล","อ่านข้อความ","อ่านเอกสาร","อ่านรายงาน","อ่านบทความ","อ่านคู่มือ","อ่านคำถาม","อ่านคำตอบ","อ่านความคิดเห็น","อ่านรีวิว","อ่านป้าย","อ่านฉลาก","อ่านสัญญา","เรียนภาษาไทย","เรียนภาษาอังกฤษ","เรียนคณิตศาสตร์","เรียนวิทยาศาสตร์","เรียนดนตรี","เรียนศิลปะ","เรียนทำอาหาร","เรียนขับรถ","เรียนเขียนโปรแกรม","เรียนออนไลน์","เรียนด้วยตนเอง","เรียนกับครู","เรียนในห้องเรียน","เรียนต่อมหาวิทยาลัย","เรียนพิเศษ","ฝึกพูด","ฝึกอ่าน","ฝึกเขียน","ฝึกฟัง","ฝึกคิด","ฝึกจำ","ฝึกคำนวณ","ฝึกทำอาหาร","ฝึกขับรถ","ฝึกว่ายน้ำ","ฝึกวิ่ง","ฝึกออกกำลังกาย","ฝึกเล่นดนตรี","ฝึกวาดรูป","ฝึกเขียนโปรแกรม","ซ่อมรถ","ซ่อมจักรยาน","ซ่อมโทรศัพท์","ซ่อมคอมพิวเตอร์","ซ่อมโทรทัศน์","ซ่อมเครื่องปรับอากาศ","ซ่อมพัดลม","ซ่อมประตู","ซ่อมหน้าต่าง","ซ่อมหลังคา","ซ่อมก๊อกน้ำ","ซ่อมท่อ","ซ่อมรองเท้า","ซ่อมเสื้อผ้า","ซ่อมอุปกรณ์","เปลี่ยนรองเท้า","เปลี่ยนรหัสผ่าน","เปลี่ยนชื่อ","เปลี่ยนที่อยู่","เปลี่ยนเบอร์โทรศัพท์","เปลี่ยนแผน","เปลี่ยนเวลา","เปลี่ยนวันนัด","เปลี่ยนเส้นทาง","เปลี่ยนงาน","เปลี่ยนโรงเรียน","เปลี่ยนภาษา","เปลี่ยนการตั้งค่า","เปลี่ยนแบตเตอรี่","ติดตั้งแอป","ติดตั้งโปรแกรม","ติดตั้งอุปกรณ์","ติดตั้งกล้อง","ติดตั้งเครื่องปรับอากาศ","ติดตั้งพัดลม","ติดตั้งหลอดไฟ","ติดตั้งประตู","ติดตั้งหน้าต่าง","ติดตั้งชั้นวาง","ติดตั้งเครื่องพิมพ์","ติดตั้งเราเตอร์","ติดตั้งซอฟต์แวร์","ติดตั้งส่วนเสริม","เชื่อมต่ออินเทอร์เน็ต","เชื่อมต่อไวไฟ","เชื่อมต่อโทรศัพท์","เชื่อมต่อคอมพิวเตอร์","เชื่อมต่อเครื่องพิมพ์","เชื่อมต่อลำโพง","เชื่อมต่อหูฟัง","เชื่อมต่อกล้อง","เชื่อมต่อเซิร์ฟเวอร์","เชื่อมต่อฐานข้อมูล","เชื่อมต่อบัญชี","เชื่อมต่ออุปกรณ์","เชื่อมต่อสายไฟ","เชื่อมต่อบลูทูธ","เชื่อมต่อเครือข่าย","บันทึกข้อความ","บันทึกวิดีโอ","บันทึกไฟล์","บันทึกเอกสาร","บันทึกรายการ","บันทึกการประชุม","บันทึกการสนทนา","บันทึกเวลา","บันทึกค่าใช้จ่าย","บันทึกรายได้","บันทึกคะแนน","บันทึกความคืบหน้า","ค้นหาข้อมูล","ค้นหาชื่อ","ค้นหาที่อยู่","ค้นหาเบอร์โทรศัพท์","ค้นหาสถานที่","ค้นหาร้านอาหาร","ค้นหาเส้นทาง","ค้นหาไฟล์","ค้นหาเอกสาร","ค้นหาข้อความ","ค้นหารูปภาพ","ค้นหาวิดีโอ","ค้นหาสินค้า","ค้นหางาน","เลือกอาหาร","เลือกเครื่องดื่ม","เลือกเสื้อผ้า","เลือกรองเท้า","เลือกบริการ","เลือกห้อง","เลือกวัน","เลือกเวลา","เลือกสถานที่","เลือกเส้นทาง","เลือกภาษา","เลือกตัวเลือก","เลือกคำตอบ","เปรียบเทียบราคา","เปรียบเทียบสินค้า","เปรียบเทียบบริการ","เปรียบเทียบผลลัพธ์","เปรียบเทียบคะแนน","เปรียบเทียบคุณภาพ","เปรียบเทียบขนาด","เปรียบเทียบน้ำหนัก","เปรียบเทียบความเร็ว","เปรียบเทียบระยะทาง","เปรียบเทียบเวลา","เปรียบเทียบตัวเลือก","เปรียบเทียบแผน","เปรียบเทียบข้อเสนอ","จองตั๋ว","จองโต๊ะ","จองโรงแรม","จองเที่ยวบิน","จองรถ","จองที่นั่ง","จองคิว","จองเวลา","จองวันนัด","จองร้านอาหาร","จองสนาม","จองห้องประชุม","จองแพ็กเกจ","จองบริการ","ยกเลิกตั๋ว","ยกเลิกนัดหมาย","ยกเลิกบริการ","ยกเลิกสมาชิก","ยกเลิกสัญญา","ยกเลิกการประชุม","ยกเลิกการเดินทาง","ยกเลิกเที่ยวบิน","ยกเลิกรายการ","ยกเลิกคำขอ","ยกเลิกใบสมัคร","ยกเลิกแผน","ยกเลิกกิจกรรม","สมัครเรียน","สมัครสมาชิก","สมัครบัญชี","สมัครบริการ","สมัครประกัน","สมัครบัตรเครดิต","สมัครโครงการ","สมัครกิจกรรม","สมัครการแข่งขัน","สมัครทุน","สมัครอีเมลข่าว","สมัครแพ็กเกจ","กรอกชื่อ","กรอกที่อยู่","กรอกเบอร์โทรศัพท์","กรอกอีเมล","กรอกแบบฟอร์ม","กรอกใบสมัคร","กรอกคำตอบ","กรอกรหัส","กรอกจำนวน","กรอกวันที่","กรอกรายละเอียด","กรอกความคิดเห็น","กรอกเหตุผล","กรอกหมายเลข","ยืนยันอีเมล","ยืนยันเบอร์โทรศัพท์","ยืนยันบัญชี","ยืนยันคำสั่งซื้อ","ยืนยันนัดหมาย","ยืนยันการชำระเงิน","ยืนยันข้อมูล","ยืนยันคำตอบ","ยืนยันการเข้าร่วม","ยืนยันข้อตกลง","ยืนยันสถานะ","ยืนยันที่อยู่","ยืนยันรหัส","ขอความช่วยเหลือ","ขอคำแนะนำ","ขอข้อมูล","ขอรายละเอียด","ขอเวลา","ขอเงิน","ขออาหาร","ขอน้ำ","ขอยา","ขอเอกสาร","ขอใบเสร็จ","ขอเลื่อนนัด","รายงานปัญหา","รายงานข้อผิดพลาด","รายงานเหตุการณ์","รายงานผลลัพธ์","รายงานยอดขาย","รายงานรายได้","รายงานค่าใช้จ่าย","รายงานข้อมูล","รายงานอุบัติเหตุ","รายงานของหาย","รายงานการทุจริต","รายงานสถานการณ์","รายงานผลตรวจ","ประชุมทีม","ประชุมพนักงาน","ประชุมลูกค้า","ประชุมผู้บริหาร","ประชุมออนไลน์","ประชุมประจำวัน","ประชุมประจำสัปดาห์","ประชุมด่วน","ประชุมวางแผน","ประชุมสรุปงาน","ประชุมติดตามงาน","ประชุมแก้ปัญหา","ประชุมเสนอผลงาน","ประชุมทบทวน","เดินทางไปโรงเรียน","เดินทางไปต่างจังหวัด","เดินทางไปต่างประเทศ","เดินทางโดยรถยนต์","เดินทางโดยรถไฟ","เดินทางโดยเครื่องบิน","เดินทางโดยเรือ","เดินทางคนเดียว","เดินทางกับครอบครัว","เดินทางไปประชุม","เดินทางไปเที่ยว","เดินทางไปโรงพยาบาล","เดินทางไปตลาด","ขับจักรยานยนต์","ขับรถบรรทุก","ขับรถตู้","ขับรถโดยสาร","ขับไปทำงาน","ขับกลับบ้าน","ขับไปตลาด","ขับไปโรงพยาบาล","ขับทางไกล","ขับขึ้นเขา","ขับกลางคืน","ขับฝ่าสายฝน","ขับช้าๆ","ขับอย่างระมัดระวัง","พักกลางคืน","พักที่บ้าน","พักที่โรงแรม","พักระหว่างทาง","พักชั่วครู่","พักหนึ่งคืน","พักหลายวัน","พักจากงาน","พักจากเรียน","พักให้หายเหนื่อย","พักในห้อง","พักนอกบ้าน","ดูแลตัวเอง","ดูแลครอบครัว","ดูแลลูก","ดูแลผู้สูงอายุ","ดูแลผู้ป่วย","ดูแลสัตว์เลี้ยง","ดูแลบ้าน","ดูแลรถ","ดูแลสุขภาพ","ดูแลผิว","ดูแลผม","ดูแลฟัน","ดูแลลูกค้า","ดูแลพนักงาน","ดูแลระบบ","ป้องกันโรค","ป้องกันอุบัติเหตุ","ป้องกันไฟไหม้","ป้องกันขโมย","ป้องกันข้อมูล","ป้องกันบัญชี","ป้องกันระบบ","ป้องกันบ้าน","ป้องกันรถ","ป้องกันความเสียหาย","ป้องกันการติดเชื้อ","ป้องกันแสงแดด","ป้องกันฝุ่น","ป้องกันน้ำท่วม","ป้องกันปัญหา","ทำนัดหมาย","ทำรายการ","ทำแผน","ทำโครงการ","ทำธุระ","ใช้โทรศัพท์","ใช้คอมพิวเตอร์","ใช้อินเทอร์เน็ต","ใช้แอป","ใช้โปรแกรม","ใช้เครื่องมือ","ใช้อุปกรณ์","ใช้เงิน","ใช้เวลา","ใช้พลังงาน","ใช้ภาษา","ใช้ข้อมูล","ใช้บริการ","ใช้สิทธิ","ใช้ส่วนลด","เก็บเสื้อผ้า","เก็บหนังสือ","เก็บเอกสาร","เก็บไฟล์","เก็บข้อมูล","เก็บอาหาร","เก็บยา","เก็บขยะ","เก็บเครื่องมือ","เก็บอุปกรณ์","เก็บความลับ","แจ้งข่าว","แจ้งข้อมูล","แจ้งปัญหา","แจ้งผลลัพธ์","แจ้งเวลา","แจ้งสถานที่","แจ้งสถานะ","แจ้งการเปลี่ยนแปลง","แจ้งเหตุผล","แจ้งรายละเอียด","แจ้งกำหนดการ","แจ้งอุบัติเหตุ","แจ้งของหาย","แจ้งยกเลิก","ถามชื่อ","ถามที่อยู่","ถามเวลา","ถามวันที่","ถามเส้นทาง","ถามเหตุผล","ถามรายละเอียด","ถามคำแนะนำ","ถามข้อมูล","ถามสถานะ","ถามผลลัพธ์","ถามความต้องการ","ถามความพร้อม","ตอบคำถาม","ตอบอีเมล","ตอบโทรศัพท์","ตอบความคิดเห็น","ตอบคำขอ","ตอบลูกค้า","ตอบเพื่อน","ตอบผู้บริหาร","ตอบแบบสอบถาม","ตอบข้อสงสัย","ตอบคำเชิญ","ตอบข้อเสนอ","ตอบข้อร้องเรียน","นำของ","นำอาหาร","นำน้ำ","นำยา","นำเอกสาร","นำไฟล์","นำข้อมูล","นำเงิน","นำเสื้อผ้า","นำอุปกรณ์","นำกระเป๋า","นำหนังสือ","นำรถ","นำผู้โดยสาร","นำทีม","รอรถ","รอเที่ยวบิน","รอเพื่อน","รอครอบครัว","รอลูกค้า","รอหมอ","รอคิว","รออาหาร","รอพัสดุ","รอคำตอบ","รอผลตรวจ","รอการอนุมัติ","รอเวลา","นัดเพื่อน","นัดช่าง","นัดครู","นัดทีม","นัดพนักงาน","นัดผู้บริหาร","นัดสัมภาษณ์","นัดตรวจสุขภาพ"];

test("fifth daily frequency batch adds exactly 600 unique headwords", () => {
  assert.equal(frequentDailyBatch600.length, 600);
  assert.equal(new Set(frequentDailyBatch600).size, 600);
});

test("fifth daily frequency batch provides curated alternatives and parts of speech", () => {
  for (const word of frequentDailyBatch600) {
    const suggestions = thesaurus.suggest(word);
    assert.ok(suggestions.length >= 3, word);
    assert.ok(suggestions.every(({ pos }) => pos.length > 0), word);
  }
...
test("fifth daily frequency batch rises from lower to higher register", () => {
  for (const word of frequentDailyBatch600) {
    const ranks = thesaurus.suggest(word).map(({ registerRank }) => registerRank);
    assert.deepEqual(ranks, [...ranks].sort((a, b) => a - b), word);
  }
...
test("fifth daily frequency batch covers representative daily actions", () => {
  for (const word of ["เปิดโทรทัศน์", "ตรวจอีเมล", "ทำความสะอาดบ้าน", "ซื้อเครื่องดื่ม", "ส่งพัสดุ", "เขียนอีเมล", "ติดตั้งแอป", "จองเที่ยวบิน", "ดูแลผู้สูงอายุ", "นัดตรวจสุขภาพ"]) {
    assert.ok(frequentDailyBatch600.includes(word), word);
    assert.ok(thesaurus.suggest(word).length >= 3, word);
  }
});

const frequentDailyBatch300Part4 = ["หยิบหนังสือ","หยิบกระเป๋า","หยิบกุญแจ","หยิบเงิน","หยิบแก้ว","หยิบจาน","หยิบช้อน","หยิบเอกสาร","หยิบเสื้อผ้า","หยิบรองเท้า","หยิบยา","หยิบของ","หยิบพัสดุ","วางกุญแจ","วางจาน","วางเอกสาร","วางเสื้อผ้า","วางรองเท้า","วางของ","วางกล่อง","วางพัสดุ","วางอุปกรณ์","ยกกล่อง","ยกกระเป๋า","ยกโต๊ะ","ยกเก้าอี้","ยกของ","ยกสินค้า","ยกอุปกรณ์","ยกมือ","ยกแขน","ยกศีรษะ","ยกจาน","ยกถัง","ยกกระถาง","ยกพัสดุ","ยกสัมภาระ","ถือโทรศัพท์","ถือกระเป๋า","ถือกุญแจ","ถือแก้ว","ถือจาน","ถือร่ม","ถือหนังสือ","ถือเอกสาร","ถือของ","ถือพัสดุ","ถือเงิน","ถือดอกไม้","ถือขวด","ถือถุง","ถืออุปกรณ์","พับเสื้อ","พับกางเกง","พับกล่อง","พับร่ม","พับขากางเกง","พับถุง","พับผ้าเช็ดตัว","พับชุด","พับแผนที่","พับโต๊ะ","แขวนกางเกง","แขวนกระเป๋า","แขวนกุญแจ","แขวนรูป","แขวนนาฬิกา","แขวนผ้า","แขวนหมวก","แขวนร่ม","แขวนของตกแต่ง","แขวนป้าย","แขวนโคมไฟ","แขวนกรอบรูป","แขวนสายไฟ","แขวนอุปกรณ์","ผูกรองเท้า","ผูกถุง","ผูกปากถุง","ผูกกล่อง","ผูกพัสดุ","ผูกผม","ผูกเนกไท","ผูกผ้าพันคอ","ผูกโบ","ผูกสายรัด","ผูกเปล","ผูกเรือ","ผูกสัตว์เลี้ยง","ผูกของ","แกะพัสดุ","แกะถุง","แกะห่อ","แกะของขวัญ","แกะฉลาก","แกะสติกเกอร์","แกะเทป","แกะเชือก","แกะเปลือก","แกะผลไม้","แกะขนม","แกะอาหาร","แกะสินค้า","แกะชิ้นส่วน","หั่นผัก","หั่นผลไม้","หั่นเนื้อ","หั่นหมู","หั่นไก่","หั่นปลา","หั่นขนมปัง","หั่นเค้ก","หั่นหัวหอม","หั่นกระเทียม","หั่นพริก","หั่นมันฝรั่ง","หั่นแครอท","หั่นแตงกวา","หั่นวัตถุดิบ","ทอดไข่","ทอดหมู","ทอดไก่","ทอดปลา","ทอดกุ้ง","ทอดเนื้อ","ทอดมันฝรั่ง","ทอดกล้วย","ทอดขนม","ทอดอาหาร","ทอดกระเทียม","ทอดหอม","ทอดแป้ง","ทอดเต้าหู้","ทอดผัก","ต้มไข่","ต้มเนื้อ","ต้มหมู","ต้มไก่","ต้มปลา","ต้มผัก","ต้มซุป","ต้มแกง","ต้มเส้น","ต้มอาหาร","ต้มนม","ต้มกาแฟ","ต้มชา","อบขนมปัง","อบเค้ก","อบคุกกี้","อบไก่","อบปลา","อบเนื้อ","อบผัก","อบมันฝรั่ง","อบอาหาร","อบขนม","อบพิซซ่า","อบแป้ง","อบเมล็ด","อบสมุนไพร","อบเสื้อผ้า","เทน้ำ","เทกาแฟ","เทชา","เทนม","เทน้ำผลไม้","เทเครื่องดื่ม","เทซุป","เทข้าว","เทอาหาร","เทน้ำมัน","เทซอส","เทผง","เททราย","เทของ","เติมน้ำมัน","เติมพริก","เติมซอส","เติมรายละเอียด","เติมคำตอบ","เติมเวลา","เติมพลังงาน","พาลูก","พาครอบครัว","พาเพื่อน","พาผู้สูงอายุ","พาผู้ป่วย","พาสัตว์เลี้ยง","พาลูกค้า","พาแขก","พานักเรียน","พาผู้โดยสาร","พาเด็ก","พาพ่อแม่","พาญาติ","พาทีม","พากลุ่ม","แวะร้านค้า","แวะร้านอาหาร","แวะร้านกาแฟ","แวะตลาด","แวะธนาคาร","แวะโรงพยาบาล","แวะร้านขายยา","แวะปั๊มน้ำมัน","แวะบ้านเพื่อน","แวะที่ทำงาน","แวะโรงเรียน","แวะไปรษณีย์","แวะห้าง","แวะห้องน้ำ","แวะระหว่างทาง","กลับที่ทำงาน","กลับโรงเรียน","กลับห้อง","กลับโรงแรม","กลับต่างจังหวัด","กลับประเทศ","กลับโต๊ะ","กลับที่นั่ง","กลับจุดเดิม","กลับเส้นทางเดิม","กลับไปทำงาน","กลับไปเรียน","กลับมาพัก","กลับคืนที่เดิม","เข้าร่วมประชุม","เข้าร่วมกิจกรรม","เข้าร่วมโครงการ","เข้าร่วมการแข่งขัน","เข้าร่วมงาน","เข้าร่วมทีม","เข้าร่วมกลุ่ม","เข้าร่วมชมรม","เข้าร่วมชั้นเรียน","เข้าร่วมสัมมนา","เข้าร่วมอบรม","เข้าร่วมพิธี","เข้าร่วมงานเลี้ยง","เข้าร่วมงานแต่ง","เข้าร่วมการสนทนา","ติดตามข่าว","ติดตามข้อมูล","ติดตามสถานการณ์","ติดตามโครงการ","ติดตามผลลัพธ์","ติดตามความคืบหน้า","ติดตามคำสั่งซื้อ","ติดตามการชำระเงิน","ติดตามลูกค้า","ติดตามผู้ป่วย","ติดตามทีม","ติดตามรายการ","ติดตามกำหนดการ","ตรวจสอบเอกสาร","ตรวจสอบยอดเงิน","ตรวจสอบบัญชี","ตรวจสอบคำสั่งซื้อ","ตรวจสอบพัสดุ","ตรวจสอบผลลัพธ์","ตรวจสอบคำตอบ","ตรวจสอบระบบ","ตรวจสอบอุปกรณ์","ตรวจสอบความถูกต้อง","แบ่งอาหาร","แบ่งขนม","แบ่งเงิน","แบ่งของ","แบ่งหน้าที่","แบ่งเวลา","แบ่งพื้นที่","แบ่งกลุ่ม","แบ่งทีม","แบ่งส่วน","แบ่งชิ้น","แบ่งข้อมูล","แบ่งรายได้","แบ่งค่าใช้จ่าย","ช่วยเพื่อน","ช่วยครอบครัว","ช่วยลูกค้า","ช่วยผู้สูงอายุ","ช่วยผู้ป่วย","ช่วยเด็ก","ช่วยนักเรียน","ช่วยครู","ช่วยพนักงาน","ช่วยทีม","ช่วยทำงาน","ช่วยทำอาหาร","ช่วยถือของ","ช่วยแก้ปัญหา","ช่วยดูแลบ้าน","คืนรถ","คืนห้อง","คืนกุญแจ","คืนบัตร","คืนเสื้อผ้า","คืนอุปกรณ์"];

test("sixth daily frequency batch adds exactly 300 unique headwords", () => {
  assert.equal(frequentDailyBatch300Part4.length, 300);
  assert.equal(new Set(frequentDailyBatch300Part4).size, 300);
});

test("sixth daily frequency batch provides curated alternatives and parts of speech", () => {
  for (const word of frequentDailyBatch300Part4) {
    const suggestions = thesaurus.suggest(word);
    assert.ok(suggestions.length >= 3, word);
    assert.ok(suggestions.every(({ pos }) => pos.length > 0), word);
  }
...
test("sixth daily frequency batch rises from lower to higher register", () => {
  for (const word of frequentDailyBatch300Part4) {
    const ranks = thesaurus.suggest(word).map(({ registerRank }) => registerRank);
    assert.deepEqual(ranks, [...ranks].sort((a, b) => a - b), word);
  }
...
test("sixth daily frequency batch covers representative daily actions", () => {
  for (const word of ["หยิบหนังสือ", "วางกุญแจ", "พับเสื้อ", "หั่นผัก", "ทอดไข่", "เติมน้ำมัน", "แวะร้านค้า", "ติดตามข่าว", "ช่วยผู้สูงอายุ", "คืนอุปกรณ์"]) {
    assert.ok(frequentDailyBatch300Part4.includes(word), word);
    assert.ok(thesaurus.suggest(word).length >= 3, word);
  }
});
